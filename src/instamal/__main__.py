...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help='Generate visualizations for the first n model instances (-v n). Creates a "vis" directory with .svg files and a `summary.pdf` in the output path. Use -v 0 to disable (default: 0).',
    )
